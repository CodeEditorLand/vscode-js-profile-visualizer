...
import {
	IClassGroup,
	INode,
} from "vscode-js-profile-core/out/esm/heapsnapshot/rpc";
...
export const sortBySelfSize: SortFn<TableNode> = (a, b) =>
	b.selfSize - a.selfSize;
export const sortByRetainedSize: SortFn<TableNode> = (a, b) =>
	b.retainedSize - a.retainedSize;
export const sortByName: SortFn<TableNode> = (a, b) =>
		...
		return (
			<BaseTimeViewRow
				...
				<div
					...
					title={
						pct &&
						`${node.selfSize} bytes, ${(pct.self * 100).toFixed(1)}% of total`
					}>
				...
				<div
					...
					title={
						pct &&
						`${node.retainedSize} bytes, ${(pct.ret * 100).toFixed(1)}% of total`
					}>
