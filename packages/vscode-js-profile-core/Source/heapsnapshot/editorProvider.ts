...
const workerRegistry = ((globalThis as any).__jsHeapSnapshotWorkers ??=
	new (class {
...
{
	public readonly onDidChangeCustomDocument = new vscode.EventEmitter<never>()
		.event;
	...
	public async resolveCustomEditor(
		...
		webviewPanel.webview.html = await bundlePage(
			...
			{
				SNAPSHOT_URI: webviewPanel.webview
